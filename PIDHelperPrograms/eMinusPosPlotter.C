...
void eMinusPosPlotter(string filelist)
{
  ...
  c1->SaveAs("multiFileHistograms/eMinusHists/posHists/eMinusXPos_MDC2020anBestCeEndpointAll.pdf");
  c1->Clear();
  eMinusYPos->Draw();
  //c1->SaveAs("multiFileHistograms/eMinusHists/posHists/rank0eMinusYPos_MDC2020anBestCeEndpointTest.pdf");
  c1->SaveAs("multiFileHistograms/eMinusHists/posHists/eMinusYPos_MDC2020anBestCeEndpointAll.pdf");
  c1->Clear();
  eMinusZPos->Draw();
  //c1->SaveAs("multiFileHistograms/eMinusHists/posHists/rank0eMinusZPos_MDC2020anBestCeEndpointTest.pdf");
  c1->SaveAs("multiFileHistograms/eMinusHists/posHists/eMinusZPos_MDC2020anBestCeEndpointAll.pdf");
  c1->Clear();
  ...
  c1->SaveAs("multiFileHistograms/eMinusHists/posHists/eMinusXYRadiusPos_MDC2020anBestCeEndpointAll.pdf");
  c1->Clear();
  ...
  c1->SaveAs("multiFileHistograms/eMinusHists/posHists/eMinusPosMagnitude_MDC2020anBestCeEndpointAll.pdf");
  c1->Clear();
  // TH2Fs
  eMinusXYPos->Draw();
  //c1->SaveAs("multiFileHistograms/eMinusHists/posHists/rank0eMinusXYPos_MDC2020anBestCeEndpointTest.pdf");
  c1->SaveAs("multiFileHistograms/eMinusHists/posHists/eMinusXYPos_MDC2020anBestCeEndpointAll.pdf");
  c1->Clear();
  eMinusXZPos->Draw();
  //c1->SaveAs("multiFileHistograms/eMinusHists/posHists/rank0eMinusXZPos_MDC2020anBestCeEndpointTest.pdf");
  c1->SaveAs("multiFileHistograms/eMinusHists/posHists/eMinusXZPos_MDC2020anBestCeEndpoinAll.pdf");
  c1->Clear();
  eMinusYZPos->Draw();
  //c1->SaveAs("multiFileHistograms/eMinusHists/posHists/rank0eMinusYZPos_MDC2020anBestCeEndpointTest.pdf");
  c1->SaveAs("multiFileHistograms/eMinusHists/posHists/eMinusYZPos_MDC2020anBestCeEndpointAll.pdf");
  c1->Clear();
  
  // TH3F (if possible)
  //TFile* eMinusXYZPosFile = new TFile("multiFileHistograms/eMinusHists/posHists/rank0eMinusXYZPosHistOutput.root", "RECREATE");
  TFile* eMinusXYZPosFile = new TFile("multiFileHistograms/eMinusHists/posHists/eMinusXYZPosHistOutputAll.root", "RECREATE");
  eMinusXYZPos->Write();
